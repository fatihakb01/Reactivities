...
/**
 * Sidebar component for filtering and narrowing down visible activities.
 *
 * Features:
 * - Filter menu for selecting:
 *   - `"all"`: Show all events
 *   - `"isGoing"`: Show events the user is attending
 *   - `"isHost"`: Show events the user is hosting
 * - Date picker for selecting a start date (via `react-calendar`)
 * - Uses MobX store actions (`setFilter`, `setStartDate`) for state updates
 *
 * Integrated with:
 * - `activityStore.filter`: Current filter type
 * - `activityStore.startDate`: Currently selected date
 *
 * @component
 *
 * @example
