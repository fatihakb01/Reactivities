...
/**
 * Displays the header section for an activity, including the category image,
 * title, host info, and relevant action buttons.
 *
 * Buttons are conditionally rendered based on whether the current user is the host.
 *
 * Props:
 * @param {Activity} props.activity - The activity object to render the header for
 *
 * Features:
 * - Displays the category image as a background
 * - Overlays activity title, date, and host information
 * - Shows a "Cancelled" chip if the activity is cancelled
 * - Shows management and toggle buttons if the user is the host
 * - Shows join/leave button for non-host users
 * - Integrates attendance mutation through `useActivities`
 * 
 * Usage:
 * ```tsx
