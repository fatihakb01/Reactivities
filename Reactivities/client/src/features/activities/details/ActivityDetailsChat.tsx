...
/**
 * Chat section of the activity details page.
 *
 * Renders a live comment feed and allows posting new comments using the `useComments` hook.
 *
 * @component
 * @example
 * <ActivityDetailsChat activityId={id} />
 */
