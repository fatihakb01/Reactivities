...
/**
 * Displays and manages a user's profile photos.
 *
 * Features:
 * - Displays all profile photos in a responsive grid.
 * - Allows current user to upload, delete, and set main photo.
 * - Toggle between photo list and photo upload mode.
 *
 * Uses the `useProfile` hook for fetching and mutating photo data.
 *
 * @example
 * <ProfilePhotos />
 */
