 ...
 *
 * Features:
 * - Uses `react-hook-form` with Zod validation (`registerSchema`)
 * - Calls `useAccount().registerUser` on submit
 * - On success: shows a toast and navigates to `/login`
 * - On error: displays field-specific validation messages
